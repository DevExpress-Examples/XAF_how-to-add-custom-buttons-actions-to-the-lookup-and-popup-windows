...
Namespace WinSolution.Module.Win
	Public Class ShowPopupController
		...
		Public Sub New()
			Dim showPopupAction As New PopupWindowShowAction(Me, "ShowPopup", DevExpress.Persistent.Base.PredefinedCategory.View)
	...
	Public Class ActionInPopupController
		Inherits ViewController
		Public Sub New()
			Dim actionInPopup As New SimpleAction(Me, "ActionInPopup", DevExpress.Persistent.Base.PredefinedCategory.PopupActions)
